...
"""
In project1.py, you will implement generic project1 algorithms which are called by
...
class SearchProblem:
    """
    This class outlines the structure of a project1 problem, but doesn't implement
    ...
    def getStartState(self):
        """
        Returns the start state for the project1 problem.
        """
...
def depthFirstSearch(problem):
    """
    Search the deepest nodes in the project1 tree first.

    Your project1 algorithm needs to return a list of actions that reaches the
    goal. Make sure to implement a graph project1 algorithm.

    To get started, you might want to try some of these simple commands to
    understand the project1 problem that is being passed in:
...
def breadthFirstSearch(problem):
    """Search the shallowest nodes in the project1 tree first."""
    "*** YOUR CODE HERE ***"
